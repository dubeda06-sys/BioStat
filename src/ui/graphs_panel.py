...
class GraphsPanel(QWidget):
    ...
    def _init_ui(self):
        ...
        gb = QGroupBox(f"  {Icons.STATS}  Vista previa")
        gl = QVBoxLayout()
        gl.setContentsMargins(4, 2, 4, 2)
        self.scroll = QScrollArea()
        self.scroll.setWidgetResizable(True)
        self.ph = QLabel(f"<div style='text-align:center;color:#a0a8b8;padding:40px;'>{Icons.CHART} Selecciona tipo y haz clic en Generar</div>")
